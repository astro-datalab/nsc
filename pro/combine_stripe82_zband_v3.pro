...
for i=0,nind-1 do begin
  ...
  if n_elements(allcat) eq 0 then begin
    ...
    allcat = replicate(cat0,4e7)
    ref0 = ref1[0]
    struct_assign,{dum:''},ref0
    allref = replicate(ref0,4e7)
    cnt = 0LL
  endif
  ;; add more elements
...
;save,allcat,allref,file='/dl1/users/dnidever/nsc/instcal/t3b/combine/combine_stripe82_zband_v3.dat'
...
pdfcombine,plots+'.pdf',plotdir+'stripe82_zband_combine.pdf',/clobber
