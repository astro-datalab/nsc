pro nsc_instcal_combine_sexdaophot,pix,version=version,nside=nside,redo=redo,stp=stp,outdir=outdir,local=local,$
...
if n_elements(pix) eq 0 then begin
  print,'Syntax - nsc_instcal_combine_sexdaophot,pix,version=version,nside=nside,redo=redo,stp=stp,outdir=outdir,'
...
schema_obj = {id:'',pix:0L,ra:0.0d0,dec:0.0d0,raerr:0.0d0,decerr:0.0d0,pmra:0.0d0,$
              ...
              bsemierr:0.0,theta:0.0,thetaerr:0.0,ellipticity:0.0,fwhm:0.0,flags:0,class_star:0.0,$
              sharp:0.0,chi:0.0,ebv:0.0}
...
mtags = ['x2','y2','xy','asemi','bsemi','theta','ellipticity','fwhm','class_star','sharp','chi']
