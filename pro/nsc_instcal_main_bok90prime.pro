;+
;
; NSC_INSTCAL_MAIN_BOK90PRIME
;
; This runs SExtractor on the Bok 90Prime InstCal images.
...
;
; USAGE:
;  IDL>nsc_instcal_main_bok90prime
;
...
pro nsc_instcal_main_bok90prime,redo=redo,nmulti=nmulti,maxjobs=maxjobs,silent=silent,unlock=unlock
...
logfile = dir+'logs/nsc_instcal_main_bok90prime.'+logtime+'.log'
JOURNAL,logfile

print, "Running SExtractor on the Bok 90Prime InstCal Images"
...
str = MRDFITS(dir+'bok90prime_instcal_list.fits',1)
nstr = n_elements(str)
print,strtrim(nstr,2),' Bok 90Prime InstCal images'
...
for i=0,ngdexp-1 do begin
  ...
  outfile = dldir+'users/dnidever/decamcatalog/instcal/ksb/'+night+'/'+baseroot+'/'+baseroot+'_'+strtrim(1,2)+'.fits'
...
runfile = dir+'logs/nsc_instcal_main_bok90prime.'+logtime+'_run.fits'
