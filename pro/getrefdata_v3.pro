...
;
; USAGE:
;  IDL>cat = getrefdata_v3('g',cenra,cendec,radius,saveref=saveref)
;
; By D. Nidever  Sep 2017
;-

function getrefdata_v3,filter,cenra,cendec,radius,count=count,saveref=saveref,silent=silent,$
...
if n_elements(filter) eq 0 or n_elements(cenra) eq 0 or n_elements(cendec) eq 0 or $
  ...
  print,'Syntax - cat = getrefdata_v3(filter,cenra,cendec,radius,saveref=saveref,dcr=dcr,'
