pro nsc_instcal_combine_v3,pix,version=version,nside=nside,redo=redo,stp=stp,outdir=outdir,local=local,$
...
print,'TEMPORARY KLUDGE!!!!!!!!  Replacing v2 -> '+version
healstr.file = repstr(healstr.file,'/v2/','/'+version+'/')
