...
pro nsc_color_relations_smashuband
...
; NUV-u vs. G-J
file = 'plots/nsc_color_relations_nuvu_gj'
...
; <NUV+G>-u vs. G-J
file = 'plots/nsc_color_relations_nuvgu_gj'
ps_open,file,/color,thick=4,/encap
f = 0.34
...
; NOW, with extinction
gg1 = where(mobj1.gaia_gmag-mobj1.tmass_jmag ge 0.70 and mobj1.gaia_gmag-mobj1.tmass_jmag le 1.1,ngg1)
a = dblarr(3,ngg1)
...
file = 'plots/nsc_color_relations_nuvgu_gj_ebv'
ps_open,file,/color,thick=4,/encap
...
; NUV-u vs. J-Ks
file = 'plots/nsc_color_relations_nuvu_jk'
ps_open,file,/color,thick=4,/encap
...
; Extinction plot
file = 'plots/nsc_color_relations_super_u_ebv_gj'
ps_open,file,/color,thick=4,/encap
...
; Scatter plot
file = 'plots/nsc_color_relations_super_u_gj_scatter'
ps_open,file,/color,thick=4,/encap
...
; Density plot
file = 'plots/nsc_color_relations_super_u_gj_density'
ps_open,file,/color,thick=4,/encap
