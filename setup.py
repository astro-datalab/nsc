...
setup(name='nsc',
      ...
      scripts=['bin/nscjobs','bin/nscjob_manager','bin/nsc_launcher','bin/nsc_download',
               'bin/nsctskserver','bin/nsccheck','bin/nsc_instcal_measure','bin/nsc_instcal_calibrate',
