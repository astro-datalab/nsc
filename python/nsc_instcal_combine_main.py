...
if __name__ == "__main__":
    ...
    if ~nocuts:
        ...
        for i in range(nzpstr):
            ...
            if nind>0:
                ...
                gg = where(np.abs(zpterm-zpf) lt (3.5*sig0 > 0.2) and str1.airmass lt 2.0 and str1.fwhm lt 2.0 and str1.rarms lt 0.15 and $
                           ...
                           np.abs(glat) gt 10 and str1.nrefmatch gt 100 and str1.exptime ge 30,ngg)
    ...
    if keyword_set(makelist) or file_test(listfile) eq 0:
        ...
        print(str(nupix)+' Healpix pixels have overlapping data')
    ...
    #gdpix = where(index.nexp lt 50 and np.abs(pixgb) gt 10 and radlmc gt 5 and radsmc gt 5,ngdpix)
    #
