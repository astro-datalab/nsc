...
import struct
from dln.pyutils.utils import *
from phot_cca import *
import glob
...
class Exposure:
    ...
    def setup(self):
        ...
        # Download images from Astro Data Archive
...
#        getdata(rawname,self.origfluxfile,self.origwtfile,self.origmaskfile,tmpdir)
        shutil.copyfile(basedir+"exposures/"+os.path.basename(self.origfluxfile),tmpdir+"/"+os.path.basename(self.origfluxfile))
        ...
        shutil.copyfile(basedir+"exposures/"+os.path.basename(self.origwtfile),tmpdir+"/"+os.path.basename(self.origwtfile))
        ...
        shutil.copyfile(basedir+"exposures/"+os.path.basename(self.origmaskfile),tmpdir+"/"+os.path.basename(self.origmaskfile))
