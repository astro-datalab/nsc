...
if __name__ == "__main__":
    ...
    copydir = localdir+"/copy_groups/"+timestamp+"/"          # where exposures will be copied to, divided
    ...
    print("splitting ",nexposures," exposures into ",nrepos," repositories")
